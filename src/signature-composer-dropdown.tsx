...
> {
  static displayName = 'SignaturePlaintextComposerDropdown';
  ...
  _staticFooterItems = [
    <div
      ...
      onMouseDown={() => {
        Actions.switchPreferencesTab('Plain-text Signatures');
        Actions.openPreferences();
      }}
    >
      <span>{localized('Edit Plain-text Signatures...')}</span>
    </div>,
  ];
      ...
      <Menu
        headerComponents={[
          <MenuItem
            ...
            checked={!currentId}
            content={localized('No plain-text signature')}
          />,
        ]}
